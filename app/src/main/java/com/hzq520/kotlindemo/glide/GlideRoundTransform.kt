...
package com.hzq520.kotlindemo.glide
...
import com.hzq520.kotlindemo.base.MyApplication
...
class GlideRoundTransform @JvmOverloads constructor(context: Context = MyApplication.context, dp: Int = 4) : BitmapTransformation() {
